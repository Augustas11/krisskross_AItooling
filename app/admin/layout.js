...
export default function AdminLayout({ children }) {
    ...
    const instagramNavigation = [
        { name: 'Instagram Inbox', href: '/crm/instagram-inbox' },
        { name: 'Pending Matches', href: '/admin/instagram-pending-matches' },
        { name: 'Sync Monitoring', href: '/admin/instagram-sync-log' },
    ];
            ...
            <div className="w-64 bg-white shadow-md flex-shrink-0 flex flex-col">
                ...
                <nav className="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                    ...
                    <div className="pt-4 mt-4 border-t border-gray-200">
                        <h3 className="px-4 text-xs font-semibold text-pink-600 uppercase tracking-wider mb-2">
                            📸 Instagram
                        </h3>
