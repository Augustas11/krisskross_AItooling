...
export const TIERS = {
    GREEN: { label: 'GREEN', minScore: 70, color: 'bg-emerald-500 text-white', border: 'border-emerald-600' },
    YELLOW: { label: 'YELLOW', minScore: 40, color: 'bg-amber-400 text-amber-950', border: 'border-amber-500' },
    RED: { label: 'RED', minScore: 0, color: 'bg-rose-500 text-white', border: 'border-rose-600' },
    GRAY: { label: 'GRAY', minScore: -1, color: 'bg-gray-100 text-gray-600', border: 'border-gray-200' } // Unscored
};
