...
export async function researchLeadWithGrok(lead) {
    ...
    try {
        ...
        5. Analyze their website and social presence to identify "Pain Points" (what is not working for them, e.g., low quality video, inconsistent posting, lack of human element, manual editing complaints).
        ...
        RETURN JSON ONLY:
        {
            ...
            "summary": "Detailed, informative research summary covering: Brand Identity & Mission, Core Product Offerings, Target Audience, Key Unique Selling Points, and Observed Pain Points (e.g. 'Their Instagram lacks reels despite being a fashion brand', 'Website product photos are static and dull'). Make this summary comprehensive and useful for sales outreach."
        }
        `;
