...
export async function enrichAndTagLead(lead, options = {}) {
    ...
    if (process.env.PERPLEXITY_API_KEY) {
        ...
        lead.ai_research_summary = "⚠️ Deep Research Unavailable: The Perplexity API is not configured for this environment. Please contact your administrator to enable AI research features.";
    }
