...
export async function researchLead(lead) {
    ...
    GOAL: Find all contact info and social media handles.
    
    STRATEGY:
    1. Search the official website's FOOTER and CONTACT page for social icons/links.
    2. Perform a specific web search for "${name} Instagram" and "${name} TikTok".
    3. Look for meta tags or links to instagram.com, tiktok.com, facebook.com.
    ...
    Research and return a STRICT JSON object with the following fields:
    {
        ...
        "website": "Corporate/Store Website (if found)",
        "tiktok": "TikTok handle/URL (if found)",
        "instagram_handle": "Instagram handle (MUST check website footer). Return null if not found. DO NOT RETURN SENTENCES.",
